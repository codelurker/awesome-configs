...
-- mocp, fs and battery
-- widgets.mocp = mpc.init({iconpath = settings.theme_path.."/music/sonata.png",
--                           width = 120})
...
function menu_clients(menu, c)
    ...
    for s = 1, screen.count() do
        ...
        table.insert(tgs_t,
                    #tgs_t + 1,
                    {
                        "New tag",
                        function()
                            new_tag_name = (c.instance and
                                            c.instance:gsub("%s.+$", "")) or nil
                            t = tag_make(new_tag_name, tag_prefix)
    ...
    menu.items = {
        ...
        {
            (client_is_maximized(c) and "Un-Maximize") or "Maximize",
            function()
                toggle_maximized(c)
            end
        },
...
for s = 1, screen.count() do
    ...
    widgets.tasklist[s] = awful.widget.tasklist(s,
        function(c)
